...
public abstract class DateUtils extends org.apache.commons.lang.time.DateUtils {
     ...
     * Patterns
     */
    public static final String DAY_INT_PATTERN = "yyMMdd";
    public static final String YEAR_DAY_INT_PATTERN = "yyyyMMdd";
    ...
    public static Date parseByDayIntPattern(String str) {
        return parseDate(str, DAY_INT_PATTERN);
    }

    public static Date parseByYearDayIntPattern(String str) {
        return parseDate(str, YEAR_DAY_INT_PATTERN);
    }
     ...
     * @return
     */
    public static String formatByDayIntPattern(Date date) {
        if (date != null) {
            return DateFormatUtils.format(date, DAY_INT_PATTERN);
        } else {
            return null;
        }
    }
